...
module.exports = async ({
  config: { CONFIG_ENCRYPTION_KEY, CONFIG_ENCRYPTION_IV, FIREBASE }, log: parentLog
}) => {
  const log = parentLog.create('firestore')

  const cipher = crypto.createDecipheriv('aes-256-cbc', CONFIG_ENCRYPTION_KEY, CONFIG_ENCRYPTION_IV)
